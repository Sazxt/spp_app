		...
		<div class="col-xl-12">
			<div class="panel panel-inverse">
				...
				<div class="panel-body">
					<div class="mb-3">
						<a href="#modal-dialog" class="btn btn-sm btn-success" data-bs-toggle="modal">Tambah kelas</a>
					</div>
				...
				<form class="form-horizontal" data-parsley-validate="true" id="datasiswa">
					<div class="modal-body">
						...
						<div class="form-group mb-3">
							<label class="form-label" for="fullname">Nama kelas * :</label>
							<input class="form-control form-control-sm" type="text" name="nama_kelas" placeholder="nama kelas" data-parsley-required="true" />
							<ul class="parsley-errors-list filled" aria-hidden="false">
								<li class="parsley-required"></li>
							</ul>
						</div>
						<div class="form-group mb-3">
							<label class="form-label" for="fullname">Sub kelas * :</label>
							<input class="form-control form-control-sm" type="text" name="sub_kelas" placeholder="sub kelas" data-parsley-required="true" />
							<ul class="parsley-errors-list filled" aria-hidden="false">
								<li class="parsley-required"></li>
							</ul>
						</div>
...
@section('js-include')
	...
	<script>
		...
		$("form#editdatasiswa").submit(function(e){
			e.preventDefault()
			urlx = '{{ route("datakelas.update", [":id"]) }}';
