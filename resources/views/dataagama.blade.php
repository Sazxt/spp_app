		...
		<div class="col-xl-12">
			<div class="panel panel-inverse">
				...
				<div class="panel-body">
					<div class="mb-3">
						<a href="#modal-dialog" class="btn btn-sm btn-success" data-bs-toggle="modal">Tambah agama</a>
					</div>
				...
				<form class="form-horizontal" data-parsley-validate="true" id="datasiswa">
					<div class="modal-body">
						...
						<div class="form-group mb-3">
							<label class="form-label" for="fullname">Nama agama * :</label>
							<input class="form-control form-control-sm" type="text" name="nama_agama" placeholder="nama agama" data-parsley-required="true" />
...
@section('js-include')
	...
	<script>
		...
		$("form#editdatasiswa").submit(function(e){
			e.preventDefault()
			urlx = '{{ route("dataagama.update", [":id"]) }}';
